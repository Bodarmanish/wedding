                ...
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        ...
                        <li class="{{ Request::url() == route('admin.dashboard') ? 'kt-menu__item--submenu kt-menu__item--active' : '' }} kt-menu__item" aria-haspopup="true">
                            <a href="{{ route('csm.dashboard') }}" class="kt-menu__link ">
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                            ...
                            <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url({{ asset('assets/media/misc/bg-1.jpg')}})">
                                ...
                                <?php $user_char = ucfirst(substr(Session::get('csm_name'), 0, 1)); ?>
                                <div class="kt-user-card__avatar">
                                    <img class="kt-hidden" alt="Pic" src="{{ asset('assets/media/users/300_25.jpg')}}" />
                                    <span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success">{{ $user_char }}</span>
                                </div>
                                <div class="kt-user-card__name">
                                    {{ Session::get('csm_name')}}
                                </div>
                            </div>


                            <div class="kt-notification">
                                <a href="{{ route('csm.edit.prifle',Session::get('csm_id')) }}" class="kt-notification__item">
                                ...
                                <a href="{{ route('csm.change.password',Session::get('csm_id')) }}" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                ...
                                <div class="kt-notification__custom kt-space-between">
                                    <a href="{{ route('csm.logout') }}" class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>
                                </div>
                            </div>
