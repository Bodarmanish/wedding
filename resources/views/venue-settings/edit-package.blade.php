			...
			<form class="kt-form edit__form" method="POST">
				...
				<div class="kt-portlet__body">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Enter Package Name" id="package_name" name="package_name" value="{{ $master->package_name }}">
							</div>
						</div>
						<div class="col-sm-12 col-md-6 col-lg-6">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-12 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<input type="number" class="form-control" placeholder="Enter Price" id="price" name="price" value="{{ $master->price }}">
							</div>
						</div>
						<div class="col-sm-12 col-md-4 col-lg-4">
							<div class="form-group">
								<label>GST (%)<span style="color: red;">*</span></label>
								<input type="number" class="form-control" placeholder="Enter GST" id="gst" name="gst" value="{{ $master->gst }}">
							</div>
						</div>
						<div class="col-sm-12 col-md-4 col-lg-4">
							<div class="form-group">
								<label>Total <span style="color: red;">*</span></label>
								<input type="number" class="form-control" readonly="" placeholder="Total" id="total" name="total" value="{{ $master->total }}">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" readonly="" placeholder="Select Time" id="timing_from" name="timing_from" value="{{ $master->timing_from }}">
							</div>
						</div>
						<div class="col-sm-12 col-md-6 col-lg-6">
							<div class="form-group">
								<label>Timing To <span style="color: red;">*</span></label>
								<input type="text" class="form-control" readonly="" placeholder="Select Time" id="timing_to" name="timing_to" value="{{ $master->timing_to }}">
							</div>
						</div>
					</div>
					...
					<div class="parent_div" id="parent_div">
						...
						<input type="hidden" name="master_id" class="master_id" id="master_id" value="{{ $row->package_master_id }}">
						<div class="row master_clone_div {{ $row->id }}__div">
							...
							<div class="col-sm-12 col-md-2 col-lg-2">
								<div class="form-group">
									...
									<input type="number" class="form-control facility_quantity" placeholder="Enter Quantity" id="facility_quantity" value="{{ $row->quantity }}" name="facility_quantity[]">
								</div>
							</div>
							<div class="col-sm-12 col-md-2 col-lg-2">
								<div class="form-group">
									<label>Price <span style="color: red;">*</span></label>
									<input type="number" class="form-control facility_price" readonly="" placeholder="Enter Price" id="facility_price" value="{{ $row->price }}" name="facility_price[]">
								</div>
							</div>
							<div class="col-sm-12 col-md-2 col-lg-2">
								<div class="form-group">
									<label>GST (%)<span style="color: red;">*</span></label>
									<input type="number" class="form-control facility_gst" value="{{ $row->gst }}" placeholder="Enter GST" id="facility_gst" name="facility_gst[]">
								</div>
							</div>
							<div class="col-sm-12 col-md-2 col-lg-2">
								<div class="form-group">
									<label>Total <span style="color: red;">*</span></label>
									<input type="number" class="form-control facility_total" readonly="" placeholder="Total" id="facility_total" value="{{ $row->total }}" name="facility_total[]">
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-2 col-lg-2">
							<div class="form-group">
								...
								<input type="number" class="form-control grand_total" readonly="" placeholder="Grand Total" id="grand_total" value="{{ $master->grand_total }}" name="grand_total">
							</div>
						</div>
						<div class="col-md-2 col-lg-2"></div>
					</div>
...
<script>
	$(document).ready(function () {
		...
		$(document).on("click", ".remove_facility", function () {
			...
			if (num_of_master_clone_div != 1) {
				...
				if(child__id != '') {
					...
					$.ajax({
						type: "POST",
						url: "{{ route('admin.venue-settings.child-data-delete') }}",
						dataType: 'json',
						// processData: false,
						// contentType: false,
						data: {
		...
		$(document).on("keyup", ".facility_quantity", function() {
			...
			// var total = parseFloat(qty) * parseFloat(price) * parseFloat(gst) / 100;
		...
		$("#update").on("click", function (e)
		{
			...
			if ($(".edit__form").valid())
			{
				...
				$.ajax({
					type: "POST",
					url: "{{ route('admin.venue-settings.update') }}",
