	...
	<div class="kt-subheader-search ">
		<div class="kt-container  kt-container--fluid ">
			<h3 class="kt-subheader-search__title">
				Users
				<span class="kt-subheader-search__desc">Add Users</span>
			</h3>
		</div>
	</div>
			...
			<form class="kt-form" method="POST" action="">
				...
				<div class="kt-portlet__body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="Enter Name" id="full_name" name="full_name">
					</div>

					<div class="form-group">
						<label for="exampleSelect1">Select Role</label>
						<select class="form-control" id="exampleSelect1" id="role" name="role">
					...
					<div class="form-group">
						...
						<input type="password" class="form-control" id="cnf_password" name="cnf_password" placeholder="Password">
					</div>
				</div>
