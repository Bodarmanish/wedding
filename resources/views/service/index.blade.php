				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						...
						<div class="kt-portlet__head-actions">
							<a href="{{ route('admin.service.services.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
				...
				<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{ route('admin.service.services.edit', $service->id) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit">
									<i class="la la-edit"></i>
								</a>

								<button class="btn btn-sm btn-clean btn-icon btn-icon-md" value="{{ $service->id }}" title="Delete" id="delete">
	...
	$(document).ready(function(){
		...
		$(document).on('click', '#delete', function ()
		{
			...
			function () {
				$.ajax({
					type: "POST",
					url: "{{ route('admin.service.services.delete') }}",
					data: 
					{
