						...
						<div class="kt-form__section kt-form__section--first">
							<div id="kt_repeater_1">
								<div class="form-group form-group-last row" id="kt_repeater_1">
									<label class="col-lg-2 col-form-label">Write Instructions:</label>
									<div data-repeater-list="" class="col-lg-10">


										<?php if(!empty($all_instructions)){ ?>
											...
											<div class="col-md-6">
												<div class="kt-form__group--inline">
													<div class="kt-form__control">
														...
														<textarea class="form-control" name="instruction[]" id="instruction" required="">{{ $data->instruction }}</textarea>
	...
	$(document).ready(function () {
        ...
        $(document).on("click", ".delete_btn", function (event) {
			...
			if(id != '')
			{
		        ...
		        function (isConfirm) {
		            $.ajax({
	                    type: "POST",
	                    url: '{{ route('admin.delete.instructions') }}',
	                    data: {
		...
		$("#save_tnc").on("click", function (e)
	    {
	        ...
	        if ($(".kt-form").valid())
	        {
	            $.ajax({
	                type: "POST",
	                url: "{{ route('admin.save.instructions', $exid) }}",
