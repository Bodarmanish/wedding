	...
	<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		...
		<div class="kt-wizard-v4__content" data-ktwizard-type="step-content">
			...
			<div class="form-group form-group-last row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						...
						<input type="number" class="form-control" placeholder="Owner Mobile 2" id="owner_mobile_second" name="owner_mobile_second" minlength="10" maxlength="10">
					</div>
				</div>
			</div>
												</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Recetion Capacity" id="recetion_capacity" name="recetion_capacity" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Floating Capacity" id="floating_capacity" name="floating_capacity" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Dinning Capacity" id="dinning_capacity" name="dinning_capacity" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Number of Rooms" id="number_of_rooms" name="number_of_rooms" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="A/c rooms" id="ac_rooms" name="ac_rooms" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Non A/c" id="non_ac_rooms" name="non_ac_rooms" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Total Area" id="total_area" name="total_area" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Number Of Chairs" id="no_of_chairs" name="no_of_chairs" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Enter number of security guards" id="security_guards" name="security_guards" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Number Of Bike Parking Capacity" id="bike_parking" name="bike_parking" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Number Of Car Parking Capacity" id="car_parking" name="car_parking" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Number Of Toilets" id="toilets" name="toilets" required="">
					</div>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-xl-9">
					<div class="input-group">
						<input type="number" class="form-control" placeholder="Number Of helpers" id="total_helpers" name="total_helpers" required="">
					</div>
				</div>
			</div>
	                ...
	                success: function (data)
	                {
	                    if (data.status === 'success') 
	                    {
							...
							toastr.options.onHidden = function(){
							  window.location="{{ route('admin.list.venue') }}";
							};
