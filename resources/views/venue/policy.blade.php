						...
						<div class="kt-form__section kt-form__section--first">
							<div id="kt_repeater_1">
								<div class="form-group form-group-last row" id="kt_repeater_1">
									<label class="col-lg-2 col-form-label">Write Cancellation Policies:</label>
									<div data-repeater-list="" class="col-lg-10">


										<?php if(!empty($canc_policy)){ ?>
										
										@foreach($canc_policy as $data)
											...
											<div class="col-md-6">
												<div class="kt-form__group--inline">
													<div class="kt-form__control">
														...
														<textarea class="form-control" name="canc_policy[]" id="canc_policy" required="">{{ $data->cancellation_policy }}</textarea>
											...
											<div class="col-md-6">
												<div class="kt-form__group--inline">
													<div class="kt-form__control">
														...
														<textarea class="form-control" name="canc_policy[]" id="canc_policy" required=""></textarea>
	...
	$(document).ready(function () {
		...
		$("#save_tnc").on("click", function (e)
	    {
	        ...
	        if ($(".kt-form").valid())
	        {
	            $.ajax({
	                type: "POST",
	                url: "{{ route('admin.save.policy', $exid) }}",
