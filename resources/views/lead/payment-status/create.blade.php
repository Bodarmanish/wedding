					...
					<form class="kt-form add__form" method="POST">
						...
						<div class="kt-portlet__body">
							...
							<div class="form-group received_payment" >
								...
								<input type="number" name="received_payment" class="form-control" id="rcce_payment" placeholder="Enter Received Payment Amount">
							</div>
							...
							<div class="form-group remaining_amount_div" >
								...
								<input type="text" readonly name="remaining_amount" class="form-control" id="remaining_amount">
							</div>
	...
	$(document).ready(function () {
		...
		$("#save").on("click", function (e)
		{
			...
			if ($(".add__form").valid())
			{
				$.ajax({
					type: "POST",
					url: "{{ route('admin.lead.payment-status.create') }}",
