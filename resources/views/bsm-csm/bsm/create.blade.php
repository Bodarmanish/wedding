                ...
                <div class="kt-portlet">
                    ...
                    <form class="kt-form edit__form" method="POST">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                <label>BSM Name <span style="color: red;">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Name" id="bsm_name" name="bsm_name" value="{{ $edit->bsm_name }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" placeholder="Enter Email for Bsm Login" id="email" name="email" value="{{ $edit->email }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>CSM Assign <span style="color: red;">*</span></label>

                                <select class="form-control kt-select2" autocomplete="off" id="kt_select2_csm" name="csm[]" multiple="multiple">
                                    <?php
                                    $assigned_id = array();
                                    foreach ($assigned_csm as $as_csm) {
                                        array_push($assigned_id, $as_csm->csm_id);
                                    }
                                    $edit_assigned_id = array();
                                    foreach ($edit_child_csm as $ec) {
                                        array_push($edit_assigned_id, $ec->csm_id);
                                    }

                                    foreach ($csm as $val) {
                                        if (in_array($val->id, $assigned_id)) {
                                            
                                        } else {
                                            $selected = '';
                                            if (in_array($val->id, $edit_assigned_id)) {
                                                $selected = ' selected';
                                            }
                                            ?>
                                            <option {{ $selected }} value="{{ $val->id }}">{{ $val->csm_name }}</option>
                                            <?php
                                        }
                                    }
                                    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2" autocomplete="off" id="kt_select2_vendor" name="vendor[]" multiple="multiple">
                                        @foreach($vendor as $val)
                                            @if(isset($bsm_vendors) && in_array($val->id, $bsm_vendors))
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                ...
                                <a href="{{ route('admin.bsm') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
                    </form>
                    ...
                    <form class="kt-form add__form" method="POST">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                <label>BSM Name <span style="color: red;">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Name" id="bsm_name" name="bsm_name">
                            </div>
                            <div class="form-group">
                                <label>Mobile <span style="color: red;">*</span></label>
                            ...
                            <div class="form-group">
                                <label>Email <span style="color: red;">*</span></label>
                                <input type="email" class="form-control" placeholder="Enter Email for Bsm Login" id="email" name="email">
                            </div>
                            <div class="form-group">
                                <label>Password <span style="color: red;">*</span></label>
                                <input type="password" class="form-control" placeholder="Enter Password for Bsm Login" id="password" name="password">
                            ...
                            <div class="form-group">
                                <label>CSM <span style="color: red;">*</span></label>

                                <select class="form-control kt-select2" autocomplete="off" id="kt_select2_csm" name="csm[]" multiple="multiple">
                                    <?php
                                    $assigned_id = array();
                                    foreach ($assigned_csm as $as_ve) {
                                        array_push($assigned_id, $as_ve->csm_id);
                                    }
                                    foreach ($csm as $val) {
                                        if (in_array($val->id, $assigned_id)) {
                                            echo 'assigned';
                                            ...
                                            ?>
                                            <option value="{{ $val->id }}">{{ $val->csm_name }}</option>
                                            <?php
                                        }
                                    }
                                    ?>
                ...
                success: function (data)
                {
                    if (data.status === 'success')
                    {
                        ...
                        toastr.options.onHidden = function () {
                            window.location = "{{ route('admin.bsm') }}";
                        };

                        toastr["success"]("BSM Added Successfully", "Success");
                    } else if (data.status === 'duplicate')
                    {
                        ...
                        toastr["warning"]("BSM already exist", "Warning");
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    if (data.status === 'success')
                    {
                        ...
                        toastr["success"]("BSM Updated Successfully", "Success");
                    } else if (data.status === 'duplicate')
                    {
                        toastr.options.timeOut = 3000;
                        toastr.options.fadeOut = 3000;
