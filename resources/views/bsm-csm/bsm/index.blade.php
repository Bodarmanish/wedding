    ...
    <div class="kt-subheader-search ">
        <div class="kt-container  kt-container--fluid ">
            <h3 class="kt-subheader-search__title">
                BSM
                <span class="kt-subheader-search__desc">BSM list</span>
            </h3>
        </div>
    </div>
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="kt-portlet__head-actions">
                            <a href="{{ route('admin.bsm.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                <table class="table table-striped- table-bordered table-hover table-checkable" id="event_type_tbl">
                    ...
                    <tbody>
                        ...
                        foreach ($all_bsm as $bsm) {
                            if ($old_user_id == '') {
                                echo '<tr>';
                                echo '<td>' . $bsm->bsm_name . '</td>';
                                echo '<td>' . $bsm->email . '</td>';
                                echo '<td>' . $bsm->mobile . '</td>';
                            }
                            if ($old_user_id != '' && $old_user_id != $bsm->id) {
                                echo '<td>' . rtrim($venue_name, ',') . '</td>';
                                echo '<td>
                                            <a href=' . route("admin.bsm.edit", $old_user_id) . ' class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit">
        ...
        swal({
            ...
            closeOnConfirm: false
                ...
                function () {
                    ...
                    swal("Deleted", "BSM has been deleted.", "success");
                });
    });
});
</script>
